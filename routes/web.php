...
//VISTA ADMINISTRADOR
//Route::view('admincapacitaciones', 'admin.capacitaciones')->name('adminCap');
Route::view('admincapacitaciones/busquedarut', 'admin.busquedarut')->name('busquedaRut'); //busqueda por rut.
