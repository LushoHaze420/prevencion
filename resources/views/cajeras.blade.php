...
<body class="p-3 m-1 border-1 bd-example">
    ...
    <form action="{{route('createCapacitacionC')}}" method="POST" enctype="multipart/form-data"><!--para subir archivos tipo file y listadocapacitaciones se enlaza en web.php-->
        @csrf
