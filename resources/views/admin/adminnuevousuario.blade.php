                        ...
                        <form> <!--<form action=route('login') method="post"></form> --> <!--crear bd para activar el action-->
                            ...
                            <div class="input-group form-group"><!--seleccion rol nuevo usuario -->
                                ...
                                <select class="form-select " name="rol_NU" aria-label="seleccion de rol">
                                    ...
                                    <option value="1" name="rol_usuario_admin">Administrador</option>
                                    <option value="2" name="rol_usuario_prevencionista">Prevencionista</option>
                                    <option value="3" name="rol_usuario_consultor">Consultor</option>
                                </select>
                            </div>

                            <div class="form-group">
                                <a class="btn float-right creaNU_btn" value="btnCreaNU" href="{{route('adminUsuariosCreados')}}">Crear</a><!--boton de prueba, comparar credenciales ocupando otro metodo-->
